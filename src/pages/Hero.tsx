...
const Hero = () => {
  return (
    <section id="home" className="snap-start bg-center bg-cover bg-no-repeat flex flex-col items-center h-[calc(100vh-72px)]" style={{ backgroundImage: `url(${forest})` }}> {/* bg-linear-to-b from-[rgba(59,47,47,0.0)] from-70% to-[rgba(63,42,42,0.8)] to-100% */}
      <div className='mt-8 flex-1 flex items-center max-w-6xl'>
